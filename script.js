    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חן תורג'מן - Top Drummer משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3a0070fe-fa81-4d16-801a-3ea0249f5ef4',
                    name: data.name || '',
                    email: data.email || '',
